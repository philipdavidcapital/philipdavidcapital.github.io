...
/* The locate control sits with the address fields it fills. */
.pdcm-locate { margin: -4px 0 20px; }
.pdcm-locate-btn {
...
.pdcm-locate-btn:hover { background: var(--navy); color: var(--cream); }
.pdcm-locate-btn:focus-visible { outline: none; box-shadow: 0 0 0 2px rgba(234, 208, 156, 0.75); }
.pdcm-locate-btn[disabled] { opacity: 0.55; cursor: default; }
.pdcm-locate-btn[disabled]:hover { background: transparent; color: var(--navy); }
.pdcm-locate .pdcm-note { margin-top: 9px; }

@media (prefers-reduced-motion: reduce) { .pdcm-locate-btn { transition: none; } }
